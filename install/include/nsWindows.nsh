...
!macro _NSW_BackgroundImg image Width Height
  System::Call 'kernel32::GetModuleHandle(i 0) i.r8'
  System::Call 'user32::CreateWindowEx(i 0, t "STATIC", t "", i ${WS_CHILD}|${WS_VISIBLE}|${SS_BITMAP}, i 0, i 0, i ${Width}, i ${Height}, i $HWNDPARENT, i 1500, i r8, i 0) i.s'
  Pop $R1
  System::Call 'user32::LoadImage(i 0, t "${image}", i 0, i 0, i 0, i 0x10) i.r9'
  SendMessage $R1 0x0172 0 $9
!macroend

!define NSW_BackgroundImg `!insertmacro _NSW_BackgroundImg`
